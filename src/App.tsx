...
function App() {
  return (
    <>
        ...
        <div className="col-start-3 col-span-8">
          ...
          <section className="grid grid-cols-2 gap-2 py-20">
            <div className="flex flex-col items-start">
              ...
              <button className="px-5 bg-lightblue py-1 text-gray-200 rounded">
                Sign up
              </button>
            </div>
        ...
        <section className="px-20  mx-20 bg-lightblue text-white col-start-2 col-span-10 items-center rounded-lg">
          <div className="grid grid-cols-12 gap-2 py-10">
            ...
            <div className="col-span-3 justify-center">
              <button className="border-2 border-white rounded-lg px-5 py-2">
                Sign up
              </button>
            </div>
          </div>
      ...
      <footer className="py-5 mt-10 bg-darkblue text-slate-50 text-center">
